...
const LogInPage=(props) =>{
    ...
    const submitHandler =()=>{
        if(props.admin.password===password && props.admin.email===email){
                ...
                <div className="login-page-content">
                    ...
                    <div className="login-page-fields">
                        <div className="login-page-email login-page-field">
                            ...
                            <input type={"email"} className="login-page-input" onChange={getEmail} placeholder='Enter your email'/>
                        </div>
                        <div className="login-page-password login-page-field">
                            <label className="login-page-label">password</label>
                            <input type={"password"} className="login-page-input" onChange={getPassword} placeholder='Enter your password'/>
                        </div>
                        <div className="login-page-buttons">
                            <button onClick={submitHandler}  className="login-page-button login-page-submit">submit</button>
                            <button onClick={cancelHandler} className="login-page-button login-page-cancel">cancel</button>
                        </div>
                    </div>
                </div>
            </div>
